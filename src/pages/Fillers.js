  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Denne side beskriver behandlinger for filler" />
      </Helmet>
      <Navigation />

      <Hero2 title="Filler" text="Filler bidrager til yngre udseende med mere karakter og hjælper med at genoprette ansigtsvolumen uden et kirurigsk indgreb. Ved at tilføje hage og kind mere fylde og former, fremhæver en filler behandling ansigtskonturer. Resultatet er et yngre udseende med mere karakter." imageUrl="/site-images/Filler-s1.webp" alt="" buttonText="Book online" onButtonClick={() => window.open("https://klinikstraarup.app4.geckobooking.dk/site/booking.php?show=new_booking&icCode=0aad36965f0f2ec512837c390542ebc2b8929&bId=8929&PHPSESSID=3d232c3793cd5f580a36db375318b752&dTpl=1", "_blank", "noreferrer")} reverse={false} />
      ...
      <FullBanner
        ...
        text={
          <>
            ...
            <p>Behandlingen kan med fordel kombineres med andre skønhedsbehandlinger såsom botox og skinbooster.</p>
            <br />
        ...
        <div className="filler-faq">
          ...
          <div className="filler-faq-text">
            ...
            <div className="filler-faq-dropdown">
              ...
              />
              <Dropdown title="Hvornår skal man massere filler?" content="De første 2 døgn efter behandlingen skal du ikke masere eller gnide på det behandlede område (med mindre at anden instruks gives af behandleren)." />
              <Dropdown
              ...
              />
              <Dropdown title="Hvilken type filler holder længst?" content="Juvéderm har en længere holdbarhed en Restylane, selvom de begge har en midlertidig effect." />
              <Dropdown
              ...
              />
              <Dropdown title="Hvornår må jeg træne efter filler?" content="Du skal undgå træning det første døgn efter behandlingen." />
            </div>
          </div>
        </div>
      </section>
