  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content='Denne side beskriver behandlinger for botox'
        />
      </Helmet>
      ...
      <Hero2
        ...
        alt='Mand i behandling med botox'
      ...
      <FullBanner
        ...
        alt='Mand i behandlingsstol hos Maria'
        reverse={false}
      />
      ...
      '
        alt1='før billede af botoxbehandling'
        imageUrl2='/site-images/botox-efter.png'
        alt2='efter billede af botoxbehandling'
      />
