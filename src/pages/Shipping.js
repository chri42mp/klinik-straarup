    ...
    <>
      ...
      <div className='max-content'>
        ...
        <div className='grid-1-1'>
          <div className='delivery-container-width'>
            ...
            <div className='shipping-terms-links'>
              <Link to='/tradeconditions'>Handelsbetingelser</Link>
            </div>
          </div>

          <div className='column'>
            <div className='shipping-basket-products'>
              {finalBasket?.basket?.map((item) => {
                ...
                console.log(product);
                return (
                  <div className='shipping-basket-item'>
                    <div className='shipping-basket-image-container'>
                      <img
                        alt={product?.productName}
                        src={product?.imagePath}
                      />
                    </div>
                    <div className='shipping-basket-product-info'>
