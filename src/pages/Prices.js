  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Denne side viser en prisliste over behandlinger" />
      </Helmet>
      <Navigation />
      <Hero2 title="Prisliste" text="Prisen på en behandling hos Klinik Straarup afhænger af den type behandling du ønsker. Book en gratis konsultation hvis du er i tvivl, så guider vi dig til en bedste løsning for dig. " imageUrl="/site-images/Skinbooster-s1.webp" alt="Calming toner" buttonText="Book nu" onButtonClick={() => console.log("Button clicked!")} reverse={false} />
      <DiscountBanner />
      <section>
