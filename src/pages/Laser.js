  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Denne side beskriver behandlinger med laser" />
      </Helmet>
      <Navigation />
      ...
      <FullBanner
        ...
        text={
          <>
            ...
            <p>Hvis du er træt af, at fjerne uønskede hår med barbering eller voks. Og vil du gerne slippe for indgroede hår, jordbærben og irriteret hud. Så er permanent hårfjerning noget for dig.</p>
          </>
        }
        ...
        <div className="laser-faq">
          ...
          <div className="laser-faq-text">
            ...
            <div className="laser-faq-dropdown">
              ...
              />
              <Dropdown title="Hvor mange behandlinger kræver permanent hårfjerning?" content="Det kræver som oftest 6-8 behandlinger at blive permanent hårfri med et behandlingsinterval på 6-8uger." />
              <Dropdown title="Gør det ondt at få laser?" content="Ved behandling mærkes laserlyset som små stik i huden. Det kan mærkes men er ikke særlig ubehageligt. " />
              <Dropdown title="Hvor lang tid skal der gå mellem hver behandling?" content="Det anbefales at der går 4-12 uger mellem hver behandling på samme område." />
            </div>
          </div>
        </div>
      </section>
