        ...
        <section className="about-s5">
          ...
          <section className="about-s5">
            <div className="s5-text">
              <h2>Patientsikkerhed</h2>
              <h5>
                Klinik Straarup er registreret hos styrelsen for
                patientsikkerhed
              </h5>
              <p>
                ...
                foregår, fordi patienten ønsker behandling af kosmetiske
                årsager. På Styrelsen for Patientsikkerheds hjemmeside kan du
                finde bekendtgørelsen.
                <br />
                <br />I bekendtgørelsens regulering indgår, at klinikken og
                dennes personer der udfører kosmetiske behandlinger, er
                registeret af Styrelsen for Patientsikkerhed, dvs. at det er
                personer der lovmæssigt opfylder kriterierne for at udføre
                kosmetiske behandlinger. Klinik Straarup er registeret jf.
                reglerne herom. <br />
