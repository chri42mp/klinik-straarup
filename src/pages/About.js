    ...
    <>
      ...
      <section className='about-s2'>
        ...
        <div className='s2-text'>
          ...
          <p>
            Vi har passion for æstetik, og holder os altid, opdateret på nyeste
            ...
            markedet, som Restylane og Vistabel. <br />
            <br /> Vores konsultationer er gratis og uforpligende. Og giver dig
            som kunde, og din behandler mulighed for at, sammen tilrettelægge en
            plan, for at opnå dine ønsker. <br />
            <br /> Vores mål er at udføre behandlinger med naturlige og subtile
      ...
      <section className='about-s5'>
        <div className='s5-text'>
          ...
          <p>
            Udførelsen af kosmetisk behandling er reguleret i bekendtgørelse nr.
            1245 af 24. oktober 2007 om kosmetisk behandling. Ved kosmetisk
            behandling er der tale om behandling, som udelukkede foregår, fordi
            patienten ønsker behandling af kosmetiske årsager. På Styrelsen for
