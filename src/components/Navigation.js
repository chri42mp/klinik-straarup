    ...
    <div className="max-content">
      <nav className="navigation">
        <div className="brand-name ">
          <Link to="/">
            <img className="logo-mobile" src="/KS-logo-element_gold.png" alt="klinik strarup logo" loading="lazy" />
            <img className="logo-web" src="/KS-logo_gold.png" alt="klinik strarup logo" loading="lazy" />
          </Link>
        </div>
        ...
        <div className={isNavExpanded ? "navigation-menu expanded" : "navigation-menu"}>
          <ul>
            ...
            <li className={`treatments ${isSubmenuVisible ? "active" : ""}`} onClick={handleSubmenuClicked}>
              <div className="align-icon">
                Behandlinger
                {isSubmenuVisible ? <ArrowUpIcon className="arrow-up-icon" /> : <ArrowDownIcon className="arrow-down-icon" />}
              </div>
              {isSubmenuVisible && (
